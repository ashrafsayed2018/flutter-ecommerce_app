import 'package:ecommerce_wael/controller/auth/verify_code_sign_up.dart';
...
class VerifyCodeSignUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    VerifyCodeSignUpControllerImpl verifyCodeSignUpControllerImpl =
          ...
          children: [
            ...
            OtpTextField(
              ...
              onSubmit: (String verificationCode) {
                verifyCodeSignUpControllerImpl.goToSuccessSignUp();
              }, // end onSubmit
            ),
          ],
        ),
